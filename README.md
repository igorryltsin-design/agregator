...
## Планы развития
- Расширение AI-поиска: обучение на пользовательском фидбэке, улучшение веса ключевых слов (см. `docs/ai_search_roadmap.md`).
- Усиление прозрачности LLM-ответов: визуализация источников, хранение оценок релевантности.
